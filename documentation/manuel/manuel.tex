...
Le programme de cette sonde ORP est en accès libre sur le site internet github sur le compte ‘fme-
...
Une fois le dossier téléchargé, il est nécessaire d’installer les librairies Python nécessaires à l’exécution du programme.
Pour cela, il faut ouvrir un terminal Ensuite, il faut exécuter la commande suivante :
\begin{verbatim}
...
Si la commande ne fonctionne pas, essayez avec :\\
\begin{verbatim}
pip install numpy matplotlib pyserial --break-system-packages
\end{verbatim}
\end{tcolorbox}
